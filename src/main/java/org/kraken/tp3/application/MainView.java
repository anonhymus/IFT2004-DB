...
import org.kraken.tp3.entity.ArticleBase;
import org.kraken.tp3.entity.ArticleEntity;
import org.kraken.tp3.entity.ArticleType;
...
/**
 * org.kraken.tp3.application.MainView.java
 *
 * @author Anonhyme
 *         12/7/2016.
 */
public class MainView extends JFrame {
    ...
    private void initPhoto() {
        ...
        labelPhotoIcon = new JLabel("Cliquer pour modifier");
        labelPhotoIcon.setBackground(Color.GRAY);
        labelPhotoIcon.setBounds(658, 32, 250, 250);
    ...
    public void refreshSelectionForm() {
        if(listeArticle.getSelectedIndex() != -1) {
            if(((ArticleBase) modelListeArticle.get(
                ...
                if(!article.getPhotoArt().isEmpty()) {
                    this.setPhoto(article.getPhotoArt());
                }
                this.setPhoto(article.getPhotoArt());
    ...
    public void setTitle(String mode) {
        super.setTitle(String.format("%s [Mode: %s]", TITLE, mode));

    }

    public JLabel getLabelAuteur() {
        return this.labelAuteur;
    }

    public JComboBox<AuteurEntity> getComboboxAuteur() {
        return this.comboboxAuteur;
    }

    public JList<String> getListeArticle() {
        return this.listeArticle;
    }

    public JTextField getTextFieldNoArticle() {
        return this.textFieldNoArticle;
    }

    public JTextField getTextFieldTitre() {
        return this.textFieldTitre;
    }

    public JTextField getTextFieldExergues() {
        return this.textFieldExergues;
    }

    public JTextField getTextFieldLongitude() {
        return this.textFieldLongitude;
    }

    public JTextField getTextFieldLatitude() {
        return this.textFieldLatitude;
    }

    public JTextArea getTextAreaLead() {
        return this.textAreaLead;
    }

    public JTextArea getTextAreaTexte() {
        return this.textAreaTexte;
    }

    public JLabel getTextAreaResultat() {
        return this.textAreaResultat;
    }

    public JComboBox<Object> getComboBoxCategorie() {
        return this.comboBoxCategorie;
    }

    public JLabel getLabelPhotoIcon() {
        return this.labelPhotoIcon;
    }
    ...
    public JButton getBtnPurger() {
        return this.btnPurger;
    }

    public DefaultListModel getModelListeArticle() {
        return this.modelListeArticle;
    }

    public DefaultComboBoxModel getModelComboBoxAuteur() {
        return this.modelComboBoxAuteur;
    }

    public DefaultComboBoxModel getModelComboBoxCategorie() {
        return this.modelComboBoxCategorie;
    }

    public void setPhoto(String path) {
        this.photoPath = path;
        this.labelPhotoIcon.setIcon(new ImageIcon(this.getClass().getResource("/" + path)));
    }
